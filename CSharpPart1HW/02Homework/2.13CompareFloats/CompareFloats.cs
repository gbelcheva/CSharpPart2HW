...
namespace _2._13CompareFloats
{
    class CompareFloats
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Input floating-point numbers to compare: ");
            double f1 = double.Parse(Console.ReadLine());
            double f2 = double.Parse(Console.ReadLine());
            double eps = 0.000001;
            bool isEqual = (Math.Abs(f1 - f2) < eps) ? true : false;
            Console.WriteLine("Equal with precision 0.000001?\n {0}", isEqual);
        }
    }
}
